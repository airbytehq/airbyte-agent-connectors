...
class GmailConnector:
    ...
    async def execute(
        self,
        entity: str,
        action: Literal["get", "list", "create", "update", "delete", "context_store_search", "context_store_sql_query"],
...
class ProfileQuery:
    ...
    async def context_store_sql_query(
        ...
        result = await self._connector.execute("profile", "context_store_sql_query", params)
        meta_data = result.get("meta")
...
class DraftsQuery:
    ...
    async def context_store_sql_query(
        ...
        result = await self._connector.execute("drafts", "context_store_sql_query", params)
        meta_data = result.get("meta")
        return AirbyteSearchResult[dict[str, Any]](
            data=result.get("data", []),
            meta=AirbyteSearchMeta(
...
class ThreadsQuery:
    ...
    async def context_store_sql_query(
        ...
        result = await self._connector.execute("threads", "context_store_sql_query", params)
        meta_data = result.get("meta")
        return AirbyteSearchResult[dict[str, Any]](
            data=result.get("data", []),
            meta=AirbyteSearchMeta(
