...
HubspotConnectorModel: ConnectorModel = ConnectorModel(
                    ...
                    CacheFieldConfig(
                        ...
                        x_airbyte_semantic_search=SemanticSearchConfig(
                            ...
                            metadata=[
                                ...
                                SemanticMetadataField(
                                    name='priority',
                                    path='/properties_hs_ticket_priority',
                                ),
                                SemanticMetadataField(
                                    name='contacts',
                                    path='/contacts[]',
                    ...
                    CacheFieldConfig(
                        ...
                        x_airbyte_semantic_search=SemanticSearchConfig(
                            ...
                            metadata=[
                                ...
                                SemanticMetadataField(
                                    name='direction',
                                    path='/properties_hs_call_direction',
                                ),
                                SemanticMetadataField(
                                    name='contacts',
                                    path='/contacts[]',
                    ...
                    CacheFieldConfig(
                        ...
                        x_airbyte_semantic_search=SemanticSearchConfig(
                            ...
                            metadata=[
                                ...
                                SemanticMetadataField(
                                    name='direction',
                                    path='/properties_hs_email_direction',
                                ),
                                SemanticMetadataField(
                                    name='contacts',
                                    path='/contacts[]',
                    ...
                    CacheFieldConfig(
                        ...
                        x_airbyte_semantic_search=SemanticSearchConfig(
                            ...
                            samples=[
                                SemanticSample(
                                    name='meeting_body',
                                    path='/properties_hs_meeting_body',
                                ),
                                SemanticSample(
                                    name='meeting_title',
                                    windowed=True,
                            ...
                            metadata=[
                                ...
                                SemanticMetadataField(
                                    name='outcome',
                                    path='/properties_hs_meeting_outcome',
                                ),
                                SemanticMetadataField(
                                    name='contacts',
                                    path='/contacts[]',
                    ...
                    CacheFieldConfig(
                        ...
                        x_airbyte_semantic_search=SemanticSearchConfig(
                            ...
                            metadata=[
                                ...
                                SemanticMetadataField(
                                    name='status',
                                    path='/properties_hs_task_status',
                                ),
                                SemanticMetadataField(
                                    name='priority',
                                    path='/properties_hs_task_priority',
                                ),
                                SemanticMetadataField(
                                    name='contacts',
                                    path='/contacts[]',
    ...
    semantic_search_fields={
        'tickets': {
            'properties_subject': SemanticSearchConfig(
                content_type='plaintext',
                samples=[
                    SemanticSample(
                        name='ticket_content',
        ...
        'notes': {
            'properties_hs_note_body': SemanticSearchConfig(
                content_type='plaintext',
                samples=[
                    SemanticSample(
                        name='note_body',
        ...
        'calls': {
            'properties_hs_call_body': SemanticSearchConfig(
                content_type='plaintext',
                samples=[
                    SemanticSample(
                        name='call_title',
        ...
        'emails': {
            'properties_hs_email_subject': SemanticSearchConfig(
                content_type='plaintext',
                samples=[
                    SemanticSample(
                        name='email_body',
        ...
        'meetings': {
            'properties_hs_meeting_title': SemanticSearchConfig(
                content_type='plaintext',
                samples=[
                    SemanticSample(
                        name='meeting_body',
        ...
        'tasks': {
            'properties_hs_task_subject': SemanticSearchConfig(
                content_type='plaintext',
                samples=[
                    SemanticSample(
                        name='task_body',
