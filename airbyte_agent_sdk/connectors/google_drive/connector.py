...
class GoogleDriveConnector:
    ...
    async def execute(
        self,
        entity: str,
        action: Literal["list", "get", "create", "update", "delete", "download", "context_store_search", "context_store_sql_query"],
...
directly returns 403.
 and save to file.
    ...
    async def context_store_sql_query(
        ...
        result = await self._connector.execute("files", "context_store_sql_query", params)
        meta_data = result.get("meta")
