...
class SubscriptionsArrayContainsCondition(TypedDict, total=False):
    """Exact membership test on an array field. Example: {"array_contains": {"tags": "premium"}}"""
    array_contains: SubscriptionsAnyValueFilter
...
SubscriptionsCondition = (
    ...
    | SubscriptionsArrayContainsCondition
...
class PlansStartswithCondition(TypedDict, total=False):
    """Literal case-insensitive prefix match."""
    startswith: PlansStringFilter


class PlansEndswithCondition(TypedDict, total=False):
    """Literal case-insensitive suffix match."""
    endswith: PlansStringFilter
...
class PlansArrayContainsCondition(TypedDict, total=False):
    """Exact membership test on an array field. Example: {"array_contains": {"tags": "premium"}}"""
    array_contains: PlansAnyValueFilter
...
PlansCondition = (
    ...
    | PlansLteCondition
    | PlansInCondition
    | PlansStartswithCondition
    | PlansEndswithCondition
    | PlansFuzzyCondition
    | PlansKeywordCondition
    | PlansContainsCondition
    | PlansArrayContainsCondition
    | PlansNotCondition
    | PlansAndCondition
    | PlansOrCondition
    | PlansAnyCondition
