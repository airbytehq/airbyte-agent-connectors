                    ...
                    CacheFieldConfig(
                        ...
                        x_airbyte_semantic_search=SemanticSearchConfig(
                            ...
                            metadata=[
                                ...
                                SemanticMetadataField(
                                    name='status',
                                    path='/incident_status.category',
                                ),
                                SemanticMetadataField(
                                    name='status_label',
                                    path='/incident_status.name',
                                ),
                                SemanticMetadataField(
                                    name='severity',
                                    path='/severity.name',
                    ...
                    CacheFieldConfig(
                        ...
                        x_airbyte_semantic_search=SemanticSearchConfig(
                            ...
                            metadata=[
                                ...
                                SemanticMetadataField(
                                    name='status',
                                    path='/new_incident_status.category',
                                ),
                                SemanticMetadataField(
                                    name='status_label',
                                    path='/new_incident_status.name',
                                ),
                                SemanticMetadataField(
                                    name='severity',
                                    path='/new_severity.name',
                                ),
                                SemanticMetadataField(
                                    name='author',
                                    path='/updater.user.name',
                                ),
                            ],
                        ),
                    ),
