...
class Link(BaseModel):
    ...
    rel: Union[str | None, Any] = Field(default=None)
    href: Union[str | None, Any] = Field(default=None)
    method: Union[str | None, Any] = Field(default=None)
    target_schema: Union[str | None, Any] = Field(default=None, alias="targetSchema")
    schema_: Union[str | None, Any] = Field(default=None, alias="schema")
...
class CampaignsList(BaseModel):
    ...
    links: Union[list[Link], Any] = Field(default=None, alias="_links")
...
class CampaignsListResultMeta(BaseModel):
    ...
    links: Union[list[Link], Any] = Field(default=None)
