...
class BasesQuery:
    ...
    async def context_store_sql_query(
        ...
        """
        Run a SQL query against bases records in the Airbyte Context Store.
        ...
        result = await self._connector.execute("bases", "context_store_sql_query", params)
        meta_data = result.get("meta")
...
class TablesQuery:
    ...
    async def context_store_sql_query(
        ...
        """
        Run a SQL query against tables records in the Airbyte Context Store.
        ...
        result = await self._connector.execute("tables", "context_store_sql_query", params)
        meta_data = result.get("meta")
        return AirbyteSearchResult[dict[str, Any]](
            data=result.get("data", []),
            meta=AirbyteSearchMeta(
