...
class AnnotationsQuery:
    ...
    async def context_store_sql_query(
        ...
        result = await self._connector.execute("annotations", "context_store_sql_query", params)
        meta_data = result.get("meta")
...
class CohortsQuery:
    ...
    async def context_store_sql_query(
        ...
        result = await self._connector.execute("cohorts", "context_store_sql_query", params)
        meta_data = result.get("meta")
        return AirbyteSearchResult[dict[str, Any]](
            data=result.get("data", []),
            meta=AirbyteSearchMeta(
...
class EventsListQuery:
    ...
    async def context_store_sql_query(
        ...
        result = await self._connector.execute("events_list", "context_store_sql_query", params)
        meta_data = result.get("meta")
        return AirbyteSearchResult[dict[str, Any]](
            data=result.get("data", []),
            meta=AirbyteSearchMeta(
...
class ActiveUsersQuery:
    ...
    async def context_store_sql_query(
        ...
        result = await self._connector.execute("active_users", "context_store_sql_query", params)
        meta_data = result.get("meta")
        return AirbyteSearchResult[dict[str, Any]](
            data=result.get("data", []),
            meta=AirbyteSearchMeta(
...
class AverageSessionLengthQuery:
    ...
    async def context_store_sql_query(
        ...
        result = await self._connector.execute("average_session_length", "context_store_sql_query", params)
        meta_data = result.get("meta")
        return AirbyteSearchResult[dict[str, Any]](
            data=result.get("data", []),
            meta=AirbyteSearchMeta(
