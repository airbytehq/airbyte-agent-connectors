...
class SitesQuery:
    ...
    async def context_store_sql_query(
        ...
        result = await self._connector.execute("sites", "context_store_sql_query", params)
        meta_data = result.get("meta")
...
class SitemapsQuery:
    ...
    async def context_store_sql_query(
        ...
        result = await self._connector.execute("sitemaps", "context_store_sql_query", params)
        meta_data = result.get("meta")
        return AirbyteSearchResult[dict[str, Any]](
            data=result.get("data", []),
            meta=AirbyteSearchMeta(
...
class SearchAnalyticsByDateQuery:
    ...
    async def context_store_sql_query(
        ...
        result = await self._connector.execute("search_analytics_by_date", "context_store_sql_query", params)
        meta_data = result.get("meta")
        return AirbyteSearchResult[dict[str, Any]](
            data=result.get("data", []),
            meta=AirbyteSearchMeta(
...
class SearchAnalyticsByCountryQuery:
    ...
    async def context_store_sql_query(
        ...
        result = await self._connector.execute("search_analytics_by_country", "context_store_sql_query", params)
        meta_data = result.get("meta")
        return AirbyteSearchResult[dict[str, Any]](
            data=result.get("data", []),
            meta=AirbyteSearchMeta(
...
class SearchAnalyticsByDeviceQuery:
    ...
    async def context_store_sql_query(
        ...
        result = await self._connector.execute("search_analytics_by_device", "context_store_sql_query", params)
        meta_data = result.get("meta")
        return AirbyteSearchResult[dict[str, Any]](
            data=result.get("data", []),
            meta=AirbyteSearchMeta(
...
class SearchAnalyticsByPageQuery:
    ...
    async def context_store_sql_query(
        ...
        result = await self._connector.execute("search_analytics_by_page", "context_store_sql_query", params)
        meta_data = result.get("meta")
        return AirbyteSearchResult[dict[str, Any]](
            data=result.get("data", []),
            meta=AirbyteSearchMeta(
...
class SearchAnalyticsByQueryQuery:
    ...
    async def context_store_sql_query(
        ...
        result = await self._connector.execute("search_analytics_by_query", "context_store_sql_query", params)
        meta_data = result.get("meta")
        return AirbyteSearchResult[dict[str, Any]](
            data=result.get("data", []),
            meta=AirbyteSearchMeta(
...
class SearchAnalyticsAllFieldsQuery:
    ...
    async def context_store_sql_query(
        ...
        result = await self._connector.execute("search_analytics_all_fields", "context_store_sql_query", params)
        meta_data = result.get("meta")
        return AirbyteSearchResult[dict[str, Any]](
            data=result.get("data", []),
            meta=AirbyteSearchMeta(
